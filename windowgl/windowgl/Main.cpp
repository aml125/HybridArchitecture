...
int main()
{
	...
	auto& pattern1 = GM::EntityBuilder::buildPattern(gameManager, iaSystem, 800, 1, 2, ALABARDERO_PATH, { -5, 1, -10 });
	...
	//Formation 2
	auto& pattern2 = GM::EntityBuilder::buildPattern(gameManager, iaSystem, 800, 1, 2, ALABARDERO_PATH, { -5, 1, 10 });
