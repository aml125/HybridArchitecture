...
int main()
{
	...
	auto& pattern1 = GM::EntityBuilder::buildPattern(gameManager, iaSystem, 10000, 10, 2, ALABARDERO_PATH, { -5, 1, -50 });
	...
	//Formation 2
	auto& pattern2 = GM::EntityBuilder::buildPattern(gameManager, iaSystem, 10000, 10, 2, ALABARDERO_PATH, { -5, 1, 50 });
